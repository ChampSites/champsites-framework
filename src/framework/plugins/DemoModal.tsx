  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 left-6 z-[100] flex items-center gap-2 bg-[#111] hover:bg-[#222] text-white px-4 py-2 rounded-full border border-white/10 shadow-xl transition-all hover:scale-105"
      >
        <Info className="w-4 h-4 text-red-500" />
        <span className="text-xs font-semibold tracking-widest uppercase">Demo Concept</span>
      </button>
        ...
        {isOpen && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
            ...
            >
              ...
              <h2 className="text-2xl font-bold font-heading text-gray-900 mb-6">Demo Website</h2>
              ...
              <div className="mt-8 pt-6 border-t border-gray-100 flex gap-3">
                <button
                  onClick={() => setIsOpen(false)}
                  className="flex-1 bg-gray-600 hover:bg-gray-700 text-white font-medium py-2.5 rounded-lg transition-colors"
                >
                  Close
                </button>
                <a
                  href="mailto:champcodes404@gmail.com"
                  className="flex-1 flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white font-medium py-2.5 rounded-lg transition-colors"
                >
